...
func NewSignInCommandHandler(userRepo userDomain.UserRepository, sessionRepo sessionDomain.Repository) *SignInCommandHandler {
...
func (h *SignInCommandHandler) Handle(ctx context.Context, cmd commands.SignInCommand) (*commands.SignInResult, error) {
